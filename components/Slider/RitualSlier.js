...
const items = [
    {
        ...
        name: 'Тимур',
        date: '03.07.2022',
        text: 'Мои максимальные рекомендации сотруднику компании Виталию! Очень оперативен, внимателен, ответственнен, к деталям что не мало важно в такой ситуации. Полностью весь процесс взял на себя!'
    },
    {
        num: '2',
        id: '_002[ujt43',
        name: 'Павел',
        date: '29.07.2022',
        text: 'Большое спасибо Виталию за деликатность, поддержку, неформальное отношение'
    },
    {
        num: '3',
        id: '_003mb673',
        name: 'Сергей',
        date: '27.07.2022',
        text: 'Работали с Виталием! Все организовано было чётко, без суеты. Во время организации интерисовались о здоровье бабушки, о самочувчствии. ' +
            'Спасибо!'
    },
    {
        num: '4',
        ...
        name: 'Игорь',
        date: '22.07.2022',
        text: 'Хочу выразить благодарность Виталию за организацию похорон моей матери!'
    },
    {
        num: '5',
        id: '_005[67gfg4h',
    ...
    },
    {
        ...
        name: 'Тимур',
        date: '17.07.2022',
        text: 'Хочу поблагодарить Виталия, за помощь в сложное для меня время. Работа была выполнена четко и слаженно.'
    },
    {
        num: '7',
        id: '_007y[jbd536',
        name: 'Татьяна',
        date: '09.06.2022',
        text: 'Я хотела бы постаыить самую высокую оценку ИП Колесник «Ритуал» после оперативного и человечного с точки зрения экономичности подхода к моей ситуации с похоронами (кремацией) отца.\n' +
    ...
    },
    {
        ...
        name: 'Татьяна',
        date: '25.05.2022',
        text: 'Хотим выразить огромную благодарность и признательность службе и Виталию. Все вопросы были решены быстро, похороны бабушки проведены достойно, Мария очень интеллигентный, внимательный и чуткий человек. Всегда была на связи, все держала под контролем. Большое спасибо, что избавили нас от лишних забот в такой тяжёлый и горький для нас этап жизни.'
    },
    {
        num: '9',
        id: '_009t43/339',
    ...
    },
    {
        ...
        name: 'Вероника',
        date: '28.02.2022',
        text: 'Благодарим Колеснику Виталию за помощь в организации прощания и оформлении документов. Все было профессионально, четко и тактично. Спасибо!'
    },
    {
        num: '11',
        id: '_011hy[frn6ne',
        name: 'АННА',
        date: '17.02.2022',
        text: 'Выражаем благодарность за помощь в организации похорон Виталию. Все понятно и в срок!\n' +
            'Спасибо\n' +
            '\n'
    },
    {
